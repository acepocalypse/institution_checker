...
| `connection_type` | Type of connection: `Alumni`, `Attended`, `Executive`, `Faculty`, `Postdoc`, `Staff`, `Other`, or `Others` (not connected) |
...
- **Others**: No connection found (used when `connected` = `N`)
...
```csv
name,institution,connected,connection_type,connection_detail,current_or_past,supporting_url,confidence,temporal_evidence
Jane Doe,Purdue University,Y,Faculty,Professor of Computer Science in the Department of CS,current,https://www.cs.purdue.edu/people/faculty/janedoe,high,Currently listed on faculty page as of 2025
John Smith,Purdue University,N,Others,No verifiable connection found in search results,N/A,,low,No temporal evidence found
Bob Johnson,Purdue University,Y,Alumni,PhD in Electrical Engineering completed in 2018,past,https://engineering.purdue.edu/ECE/Alumni/Distinguished/johnson,high,Graduated 2018; multiple references to degree completion
Mary Williams,Purdue University,Y,Executive,Former Dean of the College of Engineering from 2015-2022,past,https://www.purdue.edu/newsroom/releases/2015/Q2/williams-named-dean.html,high,Served as Dean until 2022 based on news archives
```
